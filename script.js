...
const translations = {
    ...
    'Change Location Filter': { 'hi': 'स्थान फ़िल्टर बदलें', 'te': 'స్థాన ఫిల్టర్ మార్చండి' },
    'Set Location Filter': { 'hi': 'स्थान फ़िल्टर सेट करें', 'te': 'స్థాన ఫిల్టర్ సెట్ చేయండి' },
    ...
    dropdownHtml += `
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="languageDropdown" role="button" data-bs-toggle="dropdown">
                ...
                <span id="current-language-display">${currentLanguage.toUpperCase()}</span>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="#" onclick="setLanguage('en')">English (EN)</a></li>
                <li><a class="dropdown-item" href="#" onclick="setLanguage('hi')">हिंदी (HI)</a></li>
                <li><a class="dropdown-item" href="#" onclick="setLanguage('te')">తెలుగు (TE)</a></li>
            </ul>
        </li>
    `;
